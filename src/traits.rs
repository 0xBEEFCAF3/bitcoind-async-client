...
pub trait Reader {
    ...
    /// Gets all transaction ids in mempool.
    fn get_raw_mempool_verbose(&self) -> impl Future<Output = ClientResult<GetRawMempoolVerbose>> + Send;
